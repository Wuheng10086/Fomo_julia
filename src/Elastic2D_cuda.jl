...
include("core/Structures.jl")      # 包含 CPU 结构
include("core/Structures_cuda.jl") # 包含 GPU 结构和 to_gpu
include("utils/Utils.jl")           # 包含基础工具
include("core/Kernels_cuda.jl")    # 包含 @cuda kernels
include("solvers/Solver_cuda.jl")     # 包含 solve_elastic_cuda!
