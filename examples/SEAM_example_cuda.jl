...
function run_seam_gpu_simulation()
    ...
    Vp_raw = load_segy_model("./models/SEAM/SEAM_Vp_Elastic_N23900.sgy")'
    Vs_raw = load_segy_model("./models/SEAM/SEAM_Vs_Elastic_N23900.sgy")'
    Rho_raw = load_segy_model("./models/SEAM/SEAM_Den_Elastic_N23900.sgy")'
    ...
    X = medium_cpu.x_max
    x_srcs = [0.3 * X, 0.5 * X, 0.7 * X]
    z_srcs = [10.0, 10.0, 10.0] # 10m depth
    ...
    plot_model_setup(medium_cpu, sources, receivers; savepath="SEAM_test.png")
    ...
    run_multi_shots_cuda(wavefield_gpu, medium_gpu, habc_gpu, a_gpu, geometry_gpu, dt, nt, M_order, "output/SEAM_",
        output_shot_png=true)
